...
export default function PropertyPage() {
  ...
  // Logic: ₦85M base land/location equity + (Build Cost * 1.5 multiplier)
  // Results in ~₦130M resale for a ₦30M build and ~₦160M+ for a ₦50M build
      ...
      <div className="max-w-md mx-auto bg-white shadow-2xl overflow-hidden rounded-b-[40px]">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-5 shadow-sm">
            ...
            <p className="text-[9px] text-gray-400 mt-2 italic text-center">Adjust quality for current premium materials.</p>
          </div>
          ...
          {/* UPDATED BUTTON TEXT */}
          <button onClick={() => window.open(`https://wa.me/2348105105757?text=I'm interested in ${selectedPlot.type} at ${property.title}. Build budget: ${formatN(buildCost)}. DM for more info!`, '_blank')}
